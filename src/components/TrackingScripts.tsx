...
export default async function TrackingScripts() {
  ...
  return (
    <>
      ...
      {tracking.metaDomainVerification ? (
        <meta
          name="facebook-domain-verification"
          content={tracking.metaDomainVerification}
        />
      ) : null}
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
      ...
      {tracking.linkedInInsightTag ? (
        <script
          dangerouslySetInnerHTML={{
            __html: `_linkedin_partner_id="${tracking.linkedInInsightTag}";window._linkedin_data_partner_ids=window._linkedin_data_partner_ids||[];window._linkedin_data_partner_ids.push(_linkedin_partner_id);`,
          }}
        />
      ) : null}
    </>
